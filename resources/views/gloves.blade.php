...
<body>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <a href="{{ route('gloves') }}" class="active">
        ...
        <div class="main-content">
            <h2>Neutrack Product Variety</h2>
            <div class="section">
                <img src="/images/ai.png" alt="SDG" style="width: 100%;">               
            </div>
            <div class="section">
                <img src="/images/lite.png" alt="SDG" style="width: 100%;">
            </div>
            <div class="section">
                <img src="/images/mobile.png" alt="SDG" style="width: 100%;">
            </div>
        </div>
    </div>
